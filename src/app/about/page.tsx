...
import Branddifferent from '../component/branddifferent';
...
const About = () => {
  return (
    <div>
        {/* top header */}
        <header className='w-[1515px] flex h-[41px] bg-[#2A254B]'>
        ...
        <nav className='w-[1358px] h-[134px]'>
            <div className='w-[1358px] h-[70px] pl-[10px] pt-[20px] flex '>
             ...
             <div>
             <ul className='w-[215px] h-[22px] ml-[1090px] mt-[8px] flex justify-end gap-4 items-end'>
                <li>About us</li>
                <li>Contact</li>
                <li>Blog</li>
             </ul>
         ...
         <div className='w-[1515px] h-[64px] bg-[#F9F9F9]'>
    ...
    <section>
        <div className='w-[1515px] h-[277px] flex justify-center items-center'>
  ...
  <div className='w-[1358px] h-[580px] flex'>
    ...
    <div className='w-[720px] h-[559px] bg-[#F9F9F9] ml-[9px] md:ml-[800]'>
